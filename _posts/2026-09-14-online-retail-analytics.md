...
Data was cleaned and modeled in **PostgreSQL**, then visualized in **Power BI** using custom DAX measures across four comprehensive dashboard pages. 

---

### The Business Problem Matrix

To give this analysis a true commercial edge, I set out to answer a defined set of critical performance questions across three core business stakeholder roles:
