...
<div style="margin: 20px 0; display: flex; flex-direction: column; gap: 12px; max-width: 320px;">
  <a href="https://github.com" target="_blank" rel="noopener noreferrer" style="background-color: #000; color: #fff; padding: 12px 20px; text-decoration: none; border-radius: 4px; font-weight: bold; text-align: center; font-family: sans-serif; display: block;">👉 View Full Code on GitHub</a>
  <a href="https://powerbi.com" target="_blank" rel="noopener noreferrer" style="background-color: #f2c811; color: #000; padding: 12px 20px; text-decoration: none; border-radius: 4px; font-weight: bold; text-align: center; font-family: sans-serif; display: block;">📊 Explore Live Power BI Dashboard</a>
</div>